...
def plot_options(plot_options_default, plot_function=None,
    ...
    The structure of the widgets is the following:
        ...
        marker_options.children = [markerstyle, markersize, markerfacecolor, markeredgecolor]
    ...
    linewidth = FloatTextWidget(description='Width', value=plot_options_default['linewidth'])
    markersize = IntTextWidget(description='Size', value=plot_options_default['markersize'])
    ...
    marker_options = ContainerWidget(children=[markerstyle, markersize, markerfacecolor, markeredgecolor])
    ...
    def get_values(name, value):
        ...
        plot_options_wid.selected_options['markerfacecolor'] = get_color(markerfacecolor)
        plot_options_wid.selected_options['markeredgecolor'] = get_color(markeredgecolor)
    ...
    if plot_function is not None:
        ...
        linecolor.children[1].children[0].on_trait_change(plot_function, 'value')
        linecolor.children[1].children[1].on_trait_change(plot_function, 'value')
        linecolor.children[1].children[2].on_trait_change(plot_function, 'value')
        markerfacecolor.children[0].on_trait_change(plot_function, 'value')
        markerfacecolor.children[1].children[0].on_trait_change(plot_function, 'value')
        markerfacecolor.children[1].children[1].on_trait_change(plot_function, 'value')
        markerfacecolor.children[1].children[2].on_trait_change(plot_function, 'value')
        markeredgecolor.children[0].on_trait_change(plot_function, 'value')
        markeredgecolor.children[1].children[0].on_trait_change(plot_function, 'value')
        markeredgecolor.children[1].children[1].on_trait_change(plot_function, 'value')
        markeredgecolor.children[1].children[2].on_trait_change(plot_function, 'value')

    return plot_options_wid


def format_plot_options(plot_options_wid, container_padding='1px',
    ...
    plot_options_wid.children[1].children[0].children[1].children[1].set_css('width', '1cm')
    plot_options_wid.children[1].children[1].children[1].children[1].set_css('width', '1cm')
    ...
    format_color_selection(plot_options_wid.children[1].children[0].children[1].children[2])
    format_color_selection(plot_options_wid.children[1].children[1].children[1].children[2])
    format_color_selection(plot_options_wid.children[1].children[1].children[1].children[3])
...
def update_plot_options(plot_options_wid, plot_options={'show_line':True,
                                                                'linewidth':2,
                                                                'linecolor':'r',
                                                                'linestyle':'-',
                                                                'show_marker':True,
                                                                ...
                                                                'markerstyle':'o'},
                        plot_function=None):
    plot_options_wid.children[1].children[0].children[0].value = plot_options['show_line']
    plot_options_wid.children[1].children[0].children[1].children[0].value = plot_options['linestyle']
    plot_options_wid.children[1].children[0].children[1].children[1].value = plot_options['linewidth']
    plot_options_wid.children[1].children[0].children[1].children[2].value = plot_options['linecolor']

    plot_options_wid.children[1].children[1].children[0].value = plot_options['show_marker']
    plot_options_wid.children[1].children[1].children[1].children[0].value = plot_options['markerstyle']
    plot_options_wid.children[1].children[1].children[1].children[1].value = plot_options['markersize']
    plot_options_wid.children[1].children[1].children[1].children[2].value = plot_options['markerfacecolor']
    plot_options_wid.children[1].children[1].children[1].children[3].value = plot_options['markeredgecolor']
