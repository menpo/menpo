...
def format_figure_options(figure_options_wid):
    ...
    figure_options_wid.set_css('padding', '6px')
...
def format_channel_options(channel_options_wid):
    ...
    channel_options_wid.set_css('padding', '6px')
...
def format_landmark_options(landmark_options_wid):
    ...
    landmark_options_wid.set_css('padding', '6px')
...
def format_info_print(info_wid, font_size_in_pt=9):
    r"""
    ...
    """
    info_wid.set_css('padding', '6px')
    info_wid.children[0].set_css('margin-bottom', '5px')
    fontsize = '{}pt'.format(font_size_in_pt)
    info_wid.children[1].set_css({'border': '1px solid black',
                                  'padding': '4px',
                                  'font-size': fontsize})
