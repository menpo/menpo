...
ioannis_1.landmarks['cheek_freckle'] = [752]
...
ioannis_1.landmarks['cheek_freckle'] = [32294]
...
#newFace = Face(coords = ioannis_2.coords[mins_2_to_1], coordsIndex = ioannis_1.coordsIndex)
#
#
#
