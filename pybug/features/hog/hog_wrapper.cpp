/* Generated by Cython 0.19.1 on Thu Sep  5 17:35:54 2013 */
...
#endif
#include <math.h>
#define __PYX_HAVE__pybug__features__hog__hog_wrapper
#define __PYX_HAVE_API__pybug__features__hog__hog_wrapper
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
/* Module declarations from 'pybug.features.hog.hog_wrapper' */
...
static PyObject *__pyx_f_5pybug_8features_3hog_11hog_wrapper__hog(PyArrayObject *, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_5pybug_8features_3hog_11hog_wrapper__wins_to_option_information(struct wins, __Pyx_memviewslice); /*proto*/
...
#define __Pyx_MODULE_NAME "pybug.features.hog.hog_wrapper"
int __pyx_module_is_main_pybug__features__hog__hog_wrapper = 0;

/* Implementation of 'pybug.features.hog.hog_wrapper' */
...
static char __pyx_k_59[] = "/home/nontas/.virtualenvs/pbug/src/pybug/pybug/features/hog/hog_wrapper.pyx";
static char __pyx_k_60[] = "HOGOptionInformation.__init__";
static char __pyx_k_61[] = "pybug.features.hog.hog_wrapper";
...
/* "pybug/features/hog/hog_wrapper.pyx":48
 * 
 * 
...
static PyObject *__pyx_pw_5pybug_8features_3hog_11hog_wrapper_1_hog(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_5pybug_8features_3hog_11hog_wrapper__hog(PyArrayObject *__pyx_v_image, __Pyx_memviewslice __pyx_v_options, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_hist1;
  int __pyx_v_hist2;
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":53
 *     cdef int hist2
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":54
 *     # Only 1 channel means a grayscale image
 *     cdef unsigned int is_grayscale = image.shape[2] == 1
 *     cdef int imageHeight = image.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int imageWidth = image.shape[1]
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":55
 *     cdef unsigned int is_grayscale = image.shape[2] == 1
 *     cdef int imageHeight = image.shape[0]
 *     cdef int imageWidth = image.shape[1]             # <<<<<<<<<<<<<<
 *     cdef double[:] descriptorVector
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":60
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":61
 * 
 *     cdef wins info = WindowsInformation(&options[0], imageHeight,
 *                                         imageWidth, is_grayscale)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":64
 * 
 *     # Initialize Window Image
 *     if is_grayscale == 1:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "pybug/features/hog/hog_wrapper.pyx":65
 *     # Initialize Window Image
 *     if is_grayscale == 1:
 *         windowImage = np.zeros([info.windowHeight, info.windowWidth, 1],             # <<<<<<<<<<<<<<
 *                                order='F')
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":67
 *         windowImage = np.zeros([info.windowHeight, info.windowWidth, 1],
 *                                order='F')
 *     elif is_grayscale == 1 and options[8] == 2:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_11) {
    ...
    /* "pybug/features/hog/hog_wrapper.pyx":68
 *                                order='F')
 *     elif is_grayscale == 1 and options[8] == 2:
 *         image = np.tile(image, [1, 1, 3])             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "pybug/features/hog/hog_wrapper.pyx":70
 *         image = np.tile(image, [1, 1, 3])
 *     else:
 *         windowImage = np.zeros([info.windowHeight, info.windowWidth, 3],             # <<<<<<<<<<<<<<
 *                                order='F')
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":74
 * 
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":76
 *     cdef double binsSize = ( 1 + (options[12] == 1)) * np.pi / options[9]
 * 
 *     if options[8] == 1:  # dalaltriggs             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_11) {
    ...
    /* "pybug/features/hog/hog_wrapper.pyx":77
 * 
 *     if options[8] == 1:  # dalaltriggs
 *         info.descriptorLengthPerBlock = <int>(options[11] * options[11] *             # <<<<<<<<<<<<<<
 *                                               options[9])
 ...
 */
    ...
    /* "pybug/features/hog/hog_wrapper.pyx":78
 *     if options[8] == 1:  # dalaltriggs
 *         info.descriptorLengthPerBlock = <int>(options[11] * options[11] *
 *                                               options[9])             # <<<<<<<<<<<<<<
 *         hist1 = <int>(2 + ceil(-0.5 + info.windowHeight / options[10]))
 ...
 */
    ...
    /* "pybug/features/hog/hog_wrapper.pyx":79
 *         info.descriptorLengthPerBlock = <int>(options[11] * options[11] *
 *                                               options[9])
 *         hist1 = <int>(2 + ceil(-0.5 + info.windowHeight / options[10]))             # <<<<<<<<<<<<<<
 *         hist2 = <int>(2 + ceil(-0.5 + info.windowWidth / options[10]))
 ...
 */
    ...
    /* "pybug/features/hog/hog_wrapper.pyx":80
 *                                               options[9])
 *         hist1 = <int>(2 + ceil(-0.5 + info.windowHeight / options[10]))
 *         hist2 = <int>(2 + ceil(-0.5 + info.windowWidth / options[10]))             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "pybug/features/hog/hog_wrapper.pyx":82
 *         hist2 = <int>(2 + ceil(-0.5 + info.windowWidth / options[10]))
 * 
 *         info.numberOfBlocksPerWindowVertically = <int>(hist1 - 2 - (options[11] - 1))             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "pybug/features/hog/hog_wrapper.pyx":83
 * 
 *         info.numberOfBlocksPerWindowVertically = <int>(hist1 - 2 - (options[11] - 1))
 *         info.numberOfBlocksPerWindowHorizontally = <int>(hist2 - 2 - (options[11] - 1))             # <<<<<<<<<<<<<<
 *         info.descriptorLengthPerWindow = <int>(info.numberOfBlocksPerWindowVertically *
 ...
 */
    ...
    /* "pybug/features/hog/hog_wrapper.pyx":84
 *         info.numberOfBlocksPerWindowVertically = <int>(hist1 - 2 - (options[11] - 1))
 *         info.numberOfBlocksPerWindowHorizontally = <int>(hist2 - 2 - (options[11] - 1))
 *         info.descriptorLengthPerWindow = <int>(info.numberOfBlocksPerWindowVertically *             # <<<<<<<<<<<<<<
 *                                                info.numberOfBlocksPerWindowHorizontally *
 ...
 */
    ...
    /* "pybug/features/hog/hog_wrapper.pyx":88
 *                                                info.descriptorLengthPerBlock)
 * 
 ...
 */
    ...
    /* "pybug/features/hog/hog_wrapper.pyx":89
 * 
 *         descriptorVector = np.zeros([info.descriptorLengthPerWindow], order='F')
 *         descriptorMatrix = np.zeros([info.numberOfBlocksPerWindowVertically,             # <<<<<<<<<<<<<<
 *                                      info.numberOfBlocksPerWindowHorizontally,
 ...
 */
    ...
    /* "pybug/features/hog/hog_wrapper.pyx":90
 *         descriptorVector = np.zeros([info.descriptorLengthPerWindow], order='F')
 *         descriptorMatrix = np.zeros([info.numberOfBlocksPerWindowVertically,
 *                                      info.numberOfBlocksPerWindowHorizontally,             # <<<<<<<<<<<<<<
 *                                      info.descriptorLengthPerBlock], order='F')
 ...
 */
    ...
    /* "pybug/features/hog/hog_wrapper.pyx":91
 *         descriptorMatrix = np.zeros([info.numberOfBlocksPerWindowVertically,
 *                                      info.numberOfBlocksPerWindowHorizontally,
 *                                      info.descriptorLengthPerBlock], order='F')             # <<<<<<<<<<<<<<
 *     elif options[8] == 2:  # zhuramanan
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":92
 *                                      info.numberOfBlocksPerWindowHorizontally,
 *                                      info.descriptorLengthPerBlock], order='F')
 *     elif options[8] == 2:  # zhuramanan             # <<<<<<<<<<<<<<
 *         hist1 = <int>round(<double>info.windowHeight / <double>options[10])
 ...
 */
  ...
  if (__pyx_t_11) {
    ...
    /* "pybug/features/hog/hog_wrapper.pyx":93
 *                                      info.descriptorLengthPerBlock], order='F')
 *     elif options[8] == 2:  # zhuramanan
 *         hist1 = <int>round(<double>info.windowHeight / <double>options[10])             # <<<<<<<<<<<<<<
 *         hist2 = <int>round(<double>info.windowWidth / <double>options[10])
 ...
 */
    ...
    /* "pybug/features/hog/hog_wrapper.pyx":94
 *     elif options[8] == 2:  # zhuramanan
 *         hist1 = <int>round(<double>info.windowHeight / <double>options[10])
 *         hist2 = <int>round(<double>info.windowWidth / <double>options[10])             # <<<<<<<<<<<<<<
 *         descriptorMatrix = np.zeros([np.max(hist1 - 2, 0), np.max(hist2 - 2, 0), 31],
 ...
 */
    ...
    /* "pybug/features/hog/hog_wrapper.pyx":95
 *         hist1 = <int>round(<double>info.windowHeight / <double>options[10])
 *         hist2 = <int>round(<double>info.windowWidth / <double>options[10])
 *         descriptorMatrix = np.zeros([np.max(hist1 - 2, 0), np.max(hist2 - 2, 0), 31],             # <<<<<<<<<<<<<<
 *                                     order='F')
 ...
 */
    ...
    /* "pybug/features/hog/hog_wrapper.pyx":98
 *                                     order='F')
 *         # Unused
 ...
 */
    ...
    /* "pybug/features/hog/hog_wrapper.pyx":99
 *         # Unused
 *         descriptorVector = np.empty(1)
 *         info.numberOfBlocksPerWindowHorizontally = descriptorMatrix.shape[1]             # <<<<<<<<<<<<<<
 *         info.numberOfBlocksPerWindowVertically = descriptorMatrix.shape[0]
 ...
 */
    ...
    /* "pybug/features/hog/hog_wrapper.pyx":100
 *         descriptorVector = np.empty(1)
 *         info.numberOfBlocksPerWindowHorizontally = descriptorMatrix.shape[1]
 *         info.numberOfBlocksPerWindowVertically = descriptorMatrix.shape[0]             # <<<<<<<<<<<<<<
 *         info.descriptorLengthPerBlock = descriptorMatrix.shape[2]
 ...
 */
    ...
    /* "pybug/features/hog/hog_wrapper.pyx":101
 *         info.numberOfBlocksPerWindowHorizontally = descriptorMatrix.shape[1]
 *         info.numberOfBlocksPerWindowVertically = descriptorMatrix.shape[0]
 *         info.descriptorLengthPerBlock = descriptorMatrix.shape[2]             # <<<<<<<<<<<<<<
 *         info.descriptorLengthPerWindow = (info.numberOfBlocksPerWindowHorizontally *
 ...
 */
    ...
    /* "pybug/features/hog/hog_wrapper.pyx":102
 *         info.numberOfBlocksPerWindowVertically = descriptorMatrix.shape[0]
 *         info.descriptorLengthPerBlock = descriptorMatrix.shape[2]
 *         info.descriptorLengthPerWindow = (info.numberOfBlocksPerWindowHorizontally *             # <<<<<<<<<<<<<<
 *                                           info.numberOfBlocksPerWindowVertically *
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":107
 * 
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":108
 *     # Initialize output matrices
 *     cdef double[:, :, :, :, :] windows_matrix_descriptors_matrix = np.zeros([info.numberOfWindowsVertically,
 *                                                                              info.numberOfWindowsHorizontally,             # <<<<<<<<<<<<<<
 *                                                                              info.numberOfBlocksPerWindowVertically,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":109
 *     cdef double[:, :, :, :, :] windows_matrix_descriptors_matrix = np.zeros([info.numberOfWindowsVertically,
 *                                                                              info.numberOfWindowsHorizontally,
 *                                                                              info.numberOfBlocksPerWindowVertically,             # <<<<<<<<<<<<<<
 *                                                                              info.numberOfBlocksPerWindowHorizontally,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":110
 *                                                                              info.numberOfWindowsHorizontally,
 *                                                                              info.numberOfBlocksPerWindowVertically,
 *                                                                              info.numberOfBlocksPerWindowHorizontally,             # <<<<<<<<<<<<<<
 *                                                                              info.descriptorLengthPerBlock], order='F')
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":111
 *                                                                              info.numberOfBlocksPerWindowVertically,
 *                                                                              info.numberOfBlocksPerWindowHorizontally,
 *                                                                              info.descriptorLengthPerBlock], order='F')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":113
 *                                                                              info.descriptorLengthPerBlock], order='F')
 * 
 *     cdef double[:, :, :] windows_centers_matrix = np.zeros([info.numberOfWindowsVertically,             # <<<<<<<<<<<<<<
 *                                                             info.numberOfWindowsHorizontally,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":114
 * 
 *     cdef double[:, :, :] windows_centers_matrix = np.zeros([info.numberOfWindowsVertically,
 *                                                             info.numberOfWindowsHorizontally,             # <<<<<<<<<<<<<<
 *                                                             2], order='F')
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":118
 * 
 *     # Processing
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":119
 *     # Processing
 *     MainLoop(&options[0], info, &windowImage[0, 0, 0],
 *              &descriptorMatrix[0, 0, 0], &descriptorVector[0],             # <<<<<<<<<<<<<<
 *              &image[0, 0, 0], &windows_matrix_descriptors_matrix[0, 0, 0, 0, 0],
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":120
 *     MainLoop(&options[0], info, &windowImage[0, 0, 0],
 *              &descriptorMatrix[0, 0, 0], &descriptorVector[0],
 *              &image[0, 0, 0], &windows_matrix_descriptors_matrix[0, 0, 0, 0, 0],             # <<<<<<<<<<<<<<
 *              &windows_centers_matrix[0, 0, 0])
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":121
 *              &descriptorMatrix[0, 0, 0], &descriptorVector[0],
 *              &image[0, 0, 0], &windows_matrix_descriptors_matrix[0, 0, 0, 0, 0],
 *              &windows_centers_matrix[0, 0, 0])             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":123
 *              &windows_centers_matrix[0, 0, 0])
 * 
 *     return (windows_matrix_descriptors_matrix,             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":124
 * 
 *     return (windows_matrix_descriptors_matrix,
 *             windows_centers_matrix,             # <<<<<<<<<<<<<<
 *             _wins_to_option_information(info, options))
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":125
 *     return (windows_matrix_descriptors_matrix,
 *             windows_centers_matrix,
 *             _wins_to_option_information(info, options))             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_t_33 = __pyx_f_5pybug_8features_3hog_11hog_wrapper__wins_to_option_information(__pyx_v_info, __pyx_v_options); if (unlikely(!__pyx_t_33)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 125; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_33);
  ...
  __Pyx_AddTraceback("pybug.features.hog.hog_wrapper._hog", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_image.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_5pybug_8features_3hog_11hog_wrapper_1_hog(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_5pybug_8features_3hog_11hog_wrapper_1_hog(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_r = __pyx_pf_5pybug_8features_3hog_11hog_wrapper__hog(__pyx_self, __pyx_v_image, __pyx_v_options);
  goto __pyx_L0;
  __pyx_L1_error:;
  __pyx_r = NULL;
  __pyx_L0:;
...
static PyObject *__pyx_pf_5pybug_8features_3hog_11hog_wrapper__hog(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_image, __Pyx_memviewslice __pyx_v_options) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_image;
  __Pyx_Buffer __pyx_pybuffer_image;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __pyx_t_1 = __pyx_f_5pybug_8features_3hog_11hog_wrapper__hog(__pyx_v_image, __pyx_v_options, 0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
/* "pybug/features/hog/hog_wrapper.pyx":128
 * 
 * 
...
static PyObject *__pyx_f_5pybug_8features_3hog_11hog_wrapper__wins_to_option_information(struct wins __pyx_v_w, __Pyx_memviewslice __pyx_v_options) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":129
 * 
 * cdef _wins_to_option_information(wins w, double[:] options):
 *     return HOGOptionInformation(             # <<<<<<<<<<<<<<
 *         options[0],
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":130
 * cdef _wins_to_option_information(wins w, double[:] options):
 *     return HOGOptionInformation(
 *         options[0],             # <<<<<<<<<<<<<<
 *         options[8],
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":131
 *     return HOGOptionInformation(
 *         options[0],
 *         options[8],             # <<<<<<<<<<<<<<
 *         w.numberOfWindowsHorizontally,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":132
 *         options[0],
 *         options[8],
 *         w.numberOfWindowsHorizontally,             # <<<<<<<<<<<<<<
 *         w.numberOfWindowsVertically,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":133
 *         options[8],
 *         w.numberOfWindowsHorizontally,
 *         w.numberOfWindowsVertically,             # <<<<<<<<<<<<<<
 *         w.numberOfWindows,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":134
 *         w.numberOfWindowsHorizontally,
 *         w.numberOfWindowsVertically,
 *         w.numberOfWindows,             # <<<<<<<<<<<<<<
 *         w.windowHeight,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":135
 *         w.numberOfWindowsVertically,
 *         w.numberOfWindows,
 *         w.windowHeight,             # <<<<<<<<<<<<<<
 *         w.windowWidth,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":136
 *         w.numberOfWindows,
 *         w.windowHeight,
 *         w.windowWidth,             # <<<<<<<<<<<<<<
 *         w.windowStepHorizontal,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":137
 *         w.windowHeight,
 *         w.windowWidth,
 *         w.windowStepHorizontal,             # <<<<<<<<<<<<<<
 *         w.windowStepVertical,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":138
 *         w.windowWidth,
 *         w.windowStepHorizontal,
 *         w.windowStepVertical,             # <<<<<<<<<<<<<<
 *         w.numberOfBlocksPerWindowHorizontally,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":139
 *         w.windowStepHorizontal,
 *         w.windowStepVertical,
 *         w.numberOfBlocksPerWindowHorizontally,             # <<<<<<<<<<<<<<
 *         w.numberOfBlocksPerWindowVertically,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":140
 *         w.windowStepVertical,
 *         w.numberOfBlocksPerWindowHorizontally,
 *         w.numberOfBlocksPerWindowVertically,             # <<<<<<<<<<<<<<
 *         w.descriptorLengthPerBlock,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":141
 *         w.numberOfBlocksPerWindowHorizontally,
 *         w.numberOfBlocksPerWindowVertically,
 *         w.descriptorLengthPerBlock,             # <<<<<<<<<<<<<<
 *         w.descriptorLengthPerWindow,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":142
 *         w.numberOfBlocksPerWindowVertically,
 *         w.descriptorLengthPerBlock,
 *         w.descriptorLengthPerWindow,             # <<<<<<<<<<<<<<
 *         w.imageHeight,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":143
 *         w.descriptorLengthPerBlock,
 *         w.descriptorLengthPerWindow,
 *         w.imageHeight,             # <<<<<<<<<<<<<<
 *         w.imageWidth,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":144
 *         w.descriptorLengthPerWindow,
 *         w.imageHeight,
 *         w.imageWidth,             # <<<<<<<<<<<<<<
 *         w.returnOnlyWindowsWithinImageLimits,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":145
 *         w.imageHeight,
 *         w.imageWidth,
 *         w.returnOnlyWindowsWithinImageLimits,             # <<<<<<<<<<<<<<
 *         w.inputImageIsGrayscale
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":146
 *         w.imageWidth,
 *         w.returnOnlyWindowsWithinImageLimits,
 *         w.inputImageIsGrayscale             # <<<<<<<<<<<<<<
 *     )
 ...
 */
  ...
  __Pyx_AddTraceback("pybug.features.hog.hog_wrapper._wins_to_option_information", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_5pybug_8features_3hog_11hog_wrapper_20HOGOptionInformation_1__init__(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_5pybug_8features_3hog_11hog_wrapper_20HOGOptionInformation_1__init__ = {__Pyx_NAMESTR("__init__"), (PyCFunction)__pyx_pw_5pybug_8features_3hog_11hog_wrapper_20HOGOptionInformation_1__init__, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)};
static PyObject *__pyx_pw_5pybug_8features_3hog_11hog_wrapper_20HOGOptionInformation_1__init__(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
...
static PyObject *__pyx_pf_5pybug_8features_3hog_11hog_wrapper_20HOGOptionInformation___init__(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self, PyObject *__pyx_v_type, PyObject *__pyx_v_method, PyObject *__pyx_v_horizontal_window_count, PyObject *__pyx_v_vertical_window_count, PyObject *__pyx_v_n_windows, PyObject *__pyx_v_window_height, PyObject *__pyx_v_window_width, PyObject *__pyx_v_horizontal_window_step, PyObject *__pyx_v_vertical_window_step, PyObject *__pyx_v_horizontal_window_block_count, PyObject *__pyx_v_vertical_window_block_count, PyObject *__pyx_v_hog_length_per_block, PyObject *__pyx_v_hog_length_per_window, PyObject *__pyx_v_image_height, PyObject *__pyx_v_image_width, PyObject *__pyx_v_is_padding_disabled, PyObject *__pyx_v_is_greyscale) {
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":159
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":160
 *                  is_padding_disabled, is_greyscale):
 *         self.type = 'sparse' if type == 1.0 else 'dense'
 *         self.method = 'dalaltriggs' if method == 1.0 else 'zhuramanan'             # <<<<<<<<<<<<<<
 *         self.horizontal_window_count = horizontal_window_count
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":161
 *         self.type = 'sparse' if type == 1.0 else 'dense'
 *         self.method = 'dalaltriggs' if method == 1.0 else 'zhuramanan'
 *         self.horizontal_window_count = horizontal_window_count             # <<<<<<<<<<<<<<
 *         self.vertical_window_count = vertical_window_count
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":162
 *         self.method = 'dalaltriggs' if method == 1.0 else 'zhuramanan'
 *         self.horizontal_window_count = horizontal_window_count
 *         self.vertical_window_count = vertical_window_count             # <<<<<<<<<<<<<<
 *         self.n_windows = n_windows
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":163
 *         self.horizontal_window_count = horizontal_window_count
 *         self.vertical_window_count = vertical_window_count
 *         self.n_windows = n_windows             # <<<<<<<<<<<<<<
 *         self.window_height = window_height
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":164
 *         self.vertical_window_count = vertical_window_count
 *         self.n_windows = n_windows
 *         self.window_height = window_height             # <<<<<<<<<<<<<<
 *         self.window_width = window_width
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":165
 *         self.n_windows = n_windows
 *         self.window_height = window_height
 *         self.window_width = window_width             # <<<<<<<<<<<<<<
 *         self.horizontal_window_step = horizontal_window_step
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":166
 *         self.window_height = window_height
 *         self.window_width = window_width
 *         self.horizontal_window_step = horizontal_window_step             # <<<<<<<<<<<<<<
 *         self.vertical_window_step = vertical_window_step
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":167
 *         self.window_width = window_width
 *         self.horizontal_window_step = horizontal_window_step
 *         self.vertical_window_step = vertical_window_step             # <<<<<<<<<<<<<<
 *         self.horizontal_window_block_count = horizontal_window_block_count
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":168
 *         self.horizontal_window_step = horizontal_window_step
 *         self.vertical_window_step = vertical_window_step
 *         self.horizontal_window_block_count = horizontal_window_block_count             # <<<<<<<<<<<<<<
 *         self.vertical_window_block_count = vertical_window_block_count
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":169
 *         self.vertical_window_step = vertical_window_step
 *         self.horizontal_window_block_count = horizontal_window_block_count
 *         self.vertical_window_block_count = vertical_window_block_count             # <<<<<<<<<<<<<<
 *         self.hog_length_per_block = hog_length_per_block
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":170
 *         self.horizontal_window_block_count = horizontal_window_block_count
 *         self.vertical_window_block_count = vertical_window_block_count
 *         self.hog_length_per_block = hog_length_per_block             # <<<<<<<<<<<<<<
 *         self.hog_length_per_window = hog_length_per_window
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":171
 *         self.vertical_window_block_count = vertical_window_block_count
 *         self.hog_length_per_block = hog_length_per_block
 *         self.hog_length_per_window = hog_length_per_window             # <<<<<<<<<<<<<<
 *         self.image_height = image_height
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":172
 *         self.hog_length_per_block = hog_length_per_block
 *         self.hog_length_per_window = hog_length_per_window
 *         self.image_height = image_height             # <<<<<<<<<<<<<<
 *         self.image_width = image_width
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":173
 *         self.hog_length_per_window = hog_length_per_window
 *         self.image_height = image_height
 *         self.image_width = image_width             # <<<<<<<<<<<<<<
 *         self.padding_disabled = bool(is_padding_disabled)
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":174
 *         self.image_height = image_height
 *         self.image_width = image_width
 *         self.padding_disabled = bool(is_padding_disabled)             # <<<<<<<<<<<<<<
 *         self.color = "greyscale" if is_greyscale else "rgb"
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":175
 *         self.image_width = image_width
 *         self.padding_disabled = bool(is_padding_disabled)
 *         self.color = "greyscale" if is_greyscale else "rgb"             # <<<<<<<<<<<<<<
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_5pybug_8features_3hog_11hog_wrapper_20HOGOptionInformation_3__str__(PyObject *__pyx_self, PyObject *__pyx_v_self); /*proto*/
static PyMethodDef __pyx_mdef_5pybug_8features_3hog_11hog_wrapper_20HOGOptionInformation_3__str__ = {__Pyx_NAMESTR("__str__"), (PyCFunction)__pyx_pw_5pybug_8features_3hog_11hog_wrapper_20HOGOptionInformation_3__str__, METH_O, __Pyx_DOCSTR(0)};
static PyObject *__pyx_pw_5pybug_8features_3hog_11hog_wrapper_20HOGOptionInformation_3__str__(PyObject *__pyx_self, PyObject *__pyx_v_self) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__str__ (wrapper)", 0);
  __pyx_r = __pyx_pf_5pybug_8features_3hog_11hog_wrapper_20HOGOptionInformation_2__str__(__pyx_self, ((PyObject *)__pyx_v_self));
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "pybug/features/hog/hog_wrapper.pyx":177
 *         self.color = "greyscale" if is_greyscale else "rgb"
 * 
 *     def __str__(self):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_5pybug_8features_3hog_11hog_wrapper_20HOGOptionInformation_2__str__(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_self) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":178
 * 
 *     def __str__(self):
 *         return """Input image: {0} x {1} pixels ({2})             # <<<<<<<<<<<<<<
 * {3} HOGs
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":185
 * Descriptor per window = {11} x {12} x {13} = {14} x 1
 * Method of {15}
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":186
 * Method of {15}
 * Only Windows Within Image Limits: {16}""".format(
 *             self.image_height, self.image_width, self.color,             # <<<<<<<<<<<<<<
 *             self.type,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":187
 * Only Windows Within Image Limits: {16}""".format(
 *             self.image_height, self.image_width, self.color,
 *             self.type,             # <<<<<<<<<<<<<<
 *             self.window_height, self.window_width,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":188
 *             self.image_height, self.image_width, self.color,
 *             self.type,
 *             self.window_height, self.window_width,             # <<<<<<<<<<<<<<
 *             self.vertical_window_step, self.horizontal_window_step,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":189
 *             self.type,
 *             self.window_height, self.window_width,
 *             self.vertical_window_step, self.horizontal_window_step,             # <<<<<<<<<<<<<<
 *             self.vertical_window_count, self.horizontal_window_count,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":190
 *             self.window_height, self.window_width,
 *             self.vertical_window_step, self.horizontal_window_step,
 *             self.vertical_window_count, self.horizontal_window_count,             # <<<<<<<<<<<<<<
 *             self.n_windows,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":191
 *             self.vertical_window_step, self.horizontal_window_step,
 *             self.vertical_window_count, self.horizontal_window_count,
 *             self.n_windows,             # <<<<<<<<<<<<<<
 *             self.vertical_window_block_count,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":192
 *             self.vertical_window_count, self.horizontal_window_count,
 *             self.n_windows,
 *             self.vertical_window_block_count,             # <<<<<<<<<<<<<<
 *             self.horizontal_window_block_count,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":193
 *             self.n_windows,
 *             self.vertical_window_block_count,
 *             self.horizontal_window_block_count,             # <<<<<<<<<<<<<<
 *             self.hog_length_per_block, self.hog_length_per_window,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":194
 *             self.vertical_window_block_count,
 *             self.horizontal_window_block_count,
 *             self.hog_length_per_block, self.hog_length_per_window,             # <<<<<<<<<<<<<<
 *             self.method,
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":195
 *             self.horizontal_window_block_count,
 *             self.hog_length_per_block, self.hog_length_per_window,
 *             self.method,             # <<<<<<<<<<<<<<
 *             self.padding_disabled)
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":196
 *             self.hog_length_per_block, self.hog_length_per_window,
 *             self.method,
 *             self.padding_disabled)             # <<<<<<<<<<<<<<
 */
  ...
  __Pyx_XDECREF(__pyx_t_18);
  __Pyx_XDECREF(__pyx_t_19);
  __Pyx_AddTraceback("pybug.features.hog.hog_wrapper.HOGOptionInformation.__str__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  ...
  __Pyx_NAMESTR("pybug.features.hog.hog_wrapper.memoryview"), /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_array = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("pybug.features.hog.hog_wrapper.array"), /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("pybug.features.hog.hog_wrapper.Enum"), /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("pybug.features.hog.hog_wrapper._memoryviewslice"), /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("_hog"), (PyCFunction)__pyx_pw_5pybug_8features_3hog_11hog_wrapper_1_hog, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "pybug.features.hog.hog_wrapper")) {
      if (unlikely(PyDict_SetItemString(modules, "pybug.features.hog.hog_wrapper", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  ...
  #endif
  if (__pyx_module_is_main_pybug__features__hog__hog_wrapper) {
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":4
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":150
 * 
 * 
 * class HOGOptionInformation:             # <<<<<<<<<<<<<<
 * 
 ...
 *                  window_width, horizontal_window_step, vertical_window_step,
 */
  __pyx_t_2 = __Pyx_CyFunction_NewEx(&__pyx_mdef_5pybug_8features_3hog_11hog_wrapper_20HOGOptionInformation_1__init__, 0, __pyx_n_s_60, NULL, __pyx_n_s_61, ((PyObject *)__pyx_k_codeobj_58)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 152; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
 ...
 * {3} HOGs
 */
  __pyx_t_2 = __Pyx_CyFunction_NewEx(&__pyx_mdef_5pybug_8features_3hog_11hog_wrapper_20HOGOptionInformation_3__str__, 0, __pyx_n_s_64, NULL, __pyx_n_s_61, ((PyObject *)__pyx_k_codeobj_63)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 177; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  /* "pybug/features/hog/hog_wrapper.pyx":1
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  if (__pyx_m) {
    __Pyx_AddTraceback("init pybug.features.hog.hog_wrapper", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pybug.features.hog.hog_wrapper");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
